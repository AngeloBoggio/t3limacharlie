    ...
    <div className="flex justify-center">
      <section className="py-8">
        <div className="container mx-auto">
          <div className="flex justify-center">
            <h2 className="mb-6 mr-10 text-center text-7xl font-bold">
          ...
          <div className="flex justify-center">
            <div className="flex max-w-3xl justify-center">
              <form
                ...
                className="max-w-9xl mx-auto mt-20 rounded  bg-gray-200 p-36  shadow-2xl"
              >
                <h3 className="mb-4 text-center text-7xl font-semibold">
                  Property Submission Form
                </h3>
                <p className="mb-4 flex justify-center text-lg">
                  Please leave your information and one of our experts will get
